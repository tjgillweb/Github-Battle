            ...
            {languages.map((language) => (
                <li key={language}>
                    <button 
                        ...
                        style={language === selected ? {color: '#9c0c0b'} : null}
...
export default class Popular extends React.Component{
    ...
    componentDidMount() {
        // when our app loads for the first time, it should load all the repositories
    ...
    updateLanguage(selectedLanguage){
        ...
        if(!this.state.repos[selectedLanguage]){
            ...
            .then((data) => {
                // update new repositories based on current repos i.e. update state based on previous state
                this.setState(( {repos} ) => ({
                    repos: {
                        ...repos,
                        [selectedLanguage]: data // add a new property to repos object
                    }
                }))
            })
            .catch(() => {
